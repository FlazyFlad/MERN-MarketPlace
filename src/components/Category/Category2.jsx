        ...
        <div className="py-8">
            <div className="container">
                ...
                sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    to-gray-100 text-white round-3xl relative h-[320px]
                    flex items-end">
                        <div>
                            <div className="mb-4">
                    ...
                    to-brandGreen/90 text-white round-3xl relative h-[320px]
                    flex items-start">
                        <div>
                            <div className="mb-4">
                    ...
                    to-brandBlue/90 text-white round-3xl relative h-[320px]
                    flex items-start">
                        <div>
                            <div className="mb-4">
                                <p className="mb-[2px] text-white">Enjoy</p>
