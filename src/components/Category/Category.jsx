        ...
        <div className="py-8">
            <div className="container">
                ...
                sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    to-black/70 text-white round-3xl relative h-[320px]
                    flex items-end">
                        <div>
                            <div className="mb-4">
                    ...
                    to-brandYellow/90 text-white round-3xl relative h-[320px]
                    flex items-end">
                        <div>
                            <div className="mb-4">
                    ...
                    to-primary/90 text-white round-3xl relative h-[320px]
                    flex items-end">
                        <div>
                            <div className="mb-4">
