            ...
            <div className="container">
                <div className="grid md:grid-cols-3 pb-20 pt-5">
                    ...
                    <div className="py-8 px-4">
                        ...
                        lg:pr-24 pt-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat numquam asperiores odio natus neque.</p>
                        <p className="text-gray-500 mt-4">Made by FlazyFlad</p>
                        <a href="https://github.com/FlazyFlad" target="_blank"
